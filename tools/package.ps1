...
$destination = Join-Path (Split-Path -Parent $pluginRoot) "mrn-form-$Version.zip"
$staging = Join-Path ([System.IO.Path]::GetTempPath()) ("mrnf-" + [guid]::NewGuid().ToString('N'))
$packageRoot = Join-Path $staging 'mrn-form'
